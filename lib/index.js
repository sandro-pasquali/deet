...
module.exports = (opts) => {
    ...
    // https://github.com/helmetjs/helmet#frame-options-frameguard
    // TODO: allow-from
    //
    opts.frameguard
    && ~['deny','sameorigin','allow-from'].indexOf(opts.frameguard)
    && app.use(helmet.xframe(opts.frameguard));
    ...
    // https://github.com/helmetjs/helmet#content-security-policy-contentsecuritypolicy
    // http://content-security-policy.com/
    //
    // TODO: need to filter in cases of 'none' and '*'
    //
    _.isPlainObject(opts.xssCSP) && app.use(helmet.csp([
        'defaultSrc',
        'scriptSrc',
        'styleSrc',
        'imgSrc',
